...
export default function Dashboard() {
  ...
  return (
    <div className="flex h-full w-full items-center justify-between gap-4 border border-gray-300">
      <div className="flex flex-col rounded-lg h-full p-5 w-1/4 bg-gray-50 shadow-md justify-between">
      ...
      <div className="flex flex-col rounded-lg h-full p-5 w-1/2 bg-gray-50 shadow-md">
        <div>
          <h1 className="text-2xl font-semibold text-gray-900 text-center">
            {userInfo
              ? `Bienvenido, ${userInfo.Nombre} - Puesto: ${usuario?.puesto}`
              : 'Bienvenido'}
          </h1>
      ...
      <div className="rounded-lg h-full p-5 w-1/4 bg-gray-50 shadow-md">
